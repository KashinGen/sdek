...
export const DeliveriesScreen: React.FC<DeliveriesScreenProps> = ({
  ...
  statuses
    ...
    const { deliveries, status, setStatus, page, setPage, isLoading, totalPages, error } = useDeliveries(
      initialDeliveries,
      initialStatus,
      initialPage,
      pages
  ...
  return (
    ...
    <StatusFilter onStatusChange={setStatus} currentStatus={status} statuses={statuses}/>
